            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="index1.php"><span class="glyphicon glyphicons-laptop"></span> SR universe</a></li>
						<li><a href="index4.php"><span class="glyphicon glyphicon-cog"></span> blog</a></li>
                        ?>
                        <?php
                        } else {
                        ?>
